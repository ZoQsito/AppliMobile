                ...
                <Grid container rowSpacing={1}>
                  <Grid item xs={12} sm={12} md={12}>
                    <FormControl fullWidth margin="normal">
                      ...
                      >
                        <MenuItem value="">Sélectionnez une option</MenuItem>
                        <MenuItem value="MI">MISSION</MenuItem>
                        <MenuItem value="REU">REUNION</MenuItem>
                        <MenuItem value="ABS">ABSENCE</MenuItem>
                      </Select>
                    </FormControl>
                  </Grid>
                </Grid>
              ...
              {event.title === "MI" && (
                <div>
                  ...
                  {event.autreEtablissement && (
                    <Typography variant="body1">
                      <strong>Etablissement:</strong> {event.autreEtablissement}
                    </Typography>
                  )}
                  <Typography variant="body1">
